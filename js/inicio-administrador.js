              ...
              <div class="col-md-4 col-sm-6 col-lg-4 py-1">
                  ...
                  <img class="bd-placeholder-img card-img" width="100%" height="200px" src="` + productF.images[0] + `"</img>
                      ...
                      <div class="card-body">
                          ...
                          <small class="card-text d-flex"><span class="material-icons-round">king_bed</span>` + productF.bedrooms + `</small>
                          <small class="card-text d-flex"><span class="material-icons-round">bathtub</span>` + productF.toilets + `</small>
